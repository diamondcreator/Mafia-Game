...
let phrases = [
  ...
  " Yes, I can be there.",
  " Well, if you could send me your basic background …formation before next Monday, it would be useful.",
...
setInterval(() => {
  ...
  obj.items.push({
    id: id++,
    text: phrases[Math.floor(n * phrases.length)],
    author: authors[Math.floor(n * authors.length)],
    system: false,
    color: ["blue", "grey", "orange"][Math.floor(n * 3)],
  });
}, 2000);
</script>
